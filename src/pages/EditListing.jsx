      ...
      <form onSubmit={onSubmit}>
        ...
        <div className="flex items-center mb-6">
          <div className="">
            ...
            <div className="flex w-full justify-center items-center space-x-6">
              ...
              {type === "rent" && (
                <div className="">
                  <p className="text0md w-full whitespace-nowrap">$ / Month</p>
                </div>
              )}
            </div>
          </div>
        </div>
        {offer && ( // if offer true this portion will visible
          <div className="flex items-center mb-6">
            <div className="">
              ...
              <div className="flex w-full justify-center items-center space-x-6">
                ...
                {type === "rent" && (
                  <div className="">
                    <p className="text0md w-full whitespace-nowrap">
                      $ / Month
                    </p>
                  </div>
                )}
        ...
        <div className="mb-6">
          ...
          <input
            ...
            multiple
            required
            className="w-full px-3 py-1.5 text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:bg-white focus:border-slate-600 text-center"
          />
        </div>
        <button
          type="submit"

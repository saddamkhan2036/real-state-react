        ...
        <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20 ">
          ...
          <input  type="text" id="name" value={name} onChange={onChange} placeholder="Full Name" className='mb-6 w-full px-4 py-2 text-xl text-gray-700 bg-white border-gray-300 rounded transition ease-in-out ' />
            ...
            <div className="flex justify-between whitespace-nowrap text-sm sm:text-lg">
              ...
              <Link to="/sign-in" className='text-red-500  hover:text-red-600 transition duration-200 ease-in-out ml-1'>Sign In</Link>
              <p>
            ...
            <button className='w-full bg-blue-600 px-7 py-3 text-white text-sm font-medium uppercase rounded shadow-md  hover:bg-blue-700 transition duration-150 ease-in-out hover:shadow-lg active:bg-blue-800' type="submit">Sign Up</button>

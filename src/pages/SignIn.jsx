...
export default function SignIn() {
  ...
  function onChange(e){
    ...
    setFormData((prevState) =>({
      ...prevState,
      [e.target.id] : e.target.value, // Email Data
    }));
  }
  return (
    <section>
      ...
      <div className='flex  justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto'>
        <div className='md:w-[67%] lg:w-[50%] mb-12 md:mb-6 '>
          <img src="https://images.unsplash.com/photo-1600210492493-0946911123ea?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1074&q=80" alt="key" className='w-full rounded-2xl' />
        </div>
        <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20 ">
          <form >
            ...
            <div className="flex justify-between whitespace-nowrap text-sm sm:text-lg">
              ...
              <Link to="/sign-up" className='text-red-500  hover:text-red-600 transition duration-200 ease-in-out ml-1'>Register</Link>
              <p>
            ...
            <button className='w-full bg-blue-600 px-7 py-3 text-white text-sm font-medium uppercase rounded shadow-md  hover:bg-blue-700 transition duration-150 ease-in-out hover:shadow-lg active:bg-blue-800' type="submit">Sign In</button>
